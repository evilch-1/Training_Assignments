...
//extending RouteComponentProps the issues with list around other files are gone
...
const Layout = (props: Props) => {
  ...
  //New change: using an state to "select" one of the boxes of our ui
  //-1 selects Inbox, 0 selects Starred
