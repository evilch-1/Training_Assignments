...
var SymmetricEncryption1 = /** @class */ (function () {
    function SymmetricEncryption1() {
    }
    SymmetricEncryption1.prototype.encrypt = function (data) {
        return "xyz" + data;
    };
    SymmetricEncryption1.prototype.decrypt = function (data) {
        return data.slice(3);
    };
    return SymmetricEncryption1;
}());
var AsymmetricEncryption1 = /** @class */ (function () {
    function AsymmetricEncryption1() {
    }
    AsymmetricEncryption1.prototype.encrypt = function (data) {
        return "abc" + data;
    };
    AsymmetricEncryption1.prototype.decrypt = function (data) {
        return data.slice(3);
    };
    return AsymmetricEncryption1;
}());
//Persistance cluster
...
var dbObj = new Oracle(new AsymmetricEncryption1());
dbObj.save('Hello');
function greet(xyz) {
